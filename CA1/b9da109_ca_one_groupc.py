...
def parse_data(file_path, remove_gold=False):
    ...
    Returns:
        list: A list of dictionaries, each containing:
              ...
              -> "entities": A list of tuples (start, end, label) if remove_gold is False,
...
def uncertainty_sampling(model, docs, n_samples, length_constant=200):
    ...
    for doc in docs:
        ...
        confidences = [ent._.confidence for ent in spacy_doc.ents if hasattr(ent._, "confidence")]
        if confidences:
